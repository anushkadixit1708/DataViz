...
chart<-list()
w<- c(21,40,80,120,160,203)

cols <- c("[21,40)"= "red", "[40,80)"= "blue", "[80,120)"="darkgreen","[120,160)"= "darkorange","[160,203)"= "yellow")
...
tiff(filename = "Brahmaputra3.tiff", pointsize =8, res = 600, units = "in", width = 8, height = 2, restoreConsole = TRUE, type = "cairo")
multiplot(chart[[1]], cols = 1)
dev.off()
jpeg(filename = "Brahmaputra3.jpeg", pointsize =8, res = 600, units = "in", width = 8, height = 2, restoreConsole = TRUE, type = "windows")
multiplot(chart[[1]], cols = 1)
dev.off()